...
namespace Jint
{
    ...
    public class ExecutionVisitor : IStatementVisitor, IJintVisitor, IDeserializationCallback
    {
        ...
        */
        ...
        Usings _usings = new Usings();

        public Usings Usings { get { return _usings; } }
        ...
        public void Visit(Identifier expression)
        {
            ...
            if (Result == null)
            {
                ...
                {
                    var type = typeResolver.ResolveType(propertyName);
        ...
        public void OnDeserialization(object sender)
        {
            ...
            */
            this.typeResolver = new CachedTypeResolver(this);
        }
