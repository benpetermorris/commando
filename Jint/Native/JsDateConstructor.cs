...
namespace Jint.Native {
    ...
    public class JsDateConstructor : JsConstructor {
        protected JsDateConstructor(IGlobal global, bool initializeUTC)
            ...
            DefineOwnProperty("now", new ClrFunction(new JintFunc<JsDate>(() => { return Global.DateClass.New(DateTime.Now); }), global.FunctionClass.PrototypeProperty), PropertyAttributes.DontEnum);
        ...
        public override void InitPrototype(IGlobal global) {
            ...
            Prototype.DefineOwnProperty("now", new ClrFunction(new JintFunc<JsDate>(() => { return Global.DateClass.New(DateTime.Now); }), global.FunctionClass.PrototypeProperty), PropertyAttributes.DontEnum);
